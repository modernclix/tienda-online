  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        ...
        <div className="absolute left-0 mt-2 py-2 w-full bg-lime-100 border rounded-lg px-3 border-lime-300 shadow-md">
            ...
            <ul className="ml-2 text-base">
              ...
              <li className="text-black/50 ">juanjo@example.com</li>
        <li className="mt-1">
          <NavLink
            to="/my-orders"
            onClick={toggleMenu}
        ...
        <li className="flex items-center cursor-pointer mt-1" onClick={() => {context.openCheckoutSideMenu(); toggleMenu();}}
>
          <svg
  ...
  <div className="m-1 rounded-full bg-lime-300 w-5 h-5 font-medium items-center">
    {context.cartProducts.length}
      ...
      <ul className="md:flex items-center gap-3 hidden">
        ...
        <li className="flex justify-between cursor-pointer" onClick={context.openCheckoutSideMenu}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
